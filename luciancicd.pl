...
%pwd,
 ...
 findall(AT233N1,(member(AT233N1,AT233N),
 get_item_n(AT333,AT233N1,AT233N2),
 member(AT233N2,AT233)),AT233N),
...
*/
 ...
 delete(Pred_numbers0,[[n, query_box_1], 0, _],Pred_numbers),
 ...
 (findall([ON,CN,PN],(member(Loop1b,Loop1a),Loop1b=[CN,PN],(member(PN,AT233N)->ON=old;ON=new)),Loop1c),LD1=[loop1,Loop1c]);
 (Dependencies7d2=[CN,PN],(member(PN,AT233N)->ON=old;ON=new),LD1=[ON,CN,PN]))),Dependencies7d3),
...
%trace,
 ...
 append(Comment_pred_ns3,Includes_pred_ns,Comment_pred_ns),
% Find new comments
 findall(Comment_pred_n,(member(Comment_pred_n,Comment_pred_ns),not(member(Comment_pred_n,AT233N))),Comment_pred_ns2),
...
foldr(string_concat,["../private2/luciancicd-testing/",Repository1b,"/"],Go_path3),
...
merge_files(AT233,AT133,AT333) :-
 ...
 merge_files2(AT2331,AT1331,[],AT3331),
 foldr(append,AT3331,AT333).
...
merge_files3(AT2331,AT1331,AT333%,AT3331
 ...
 foldr(append,[C,Ps,[[Pred_name1|Rest4]],A],AT1334);
